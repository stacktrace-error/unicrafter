...
public class ChanceRecipe extends Recipe{
    ...
    /**Add an output range. This will add onto the normal out().*/
    public void addChanceOut(float fraction, Object... items){
        ChanceOut add = new ChanceOut(lastRange, lastRange += fraction);
